...
function parseMaxLoad(peopleTransfer: boolean, amount: number) {
  const template = `Up to ${amount} `
  return peopleTransfer ? template + "people" : template + "kg"
}
    ...
    <Card className={classes.noticeCard}>
      ...
      <CardContent className={classes.cardBody}>
        <Box className={classes.generalData}>
          ...
          <Typography className={classes.vehicleInfo}>({props.data.noticeProvider})</Typography>
        </Box>
        <Typography className={classes.maxWeight}>
          {parseMaxLoad(props.data.peopleTransfer, props.data.maxAmount)}
        </Typography>
...
// }));
//
// export default function BoardNotice(props: IBoardNoticeProps) {
//   const classes = useStyles();
